...
class GetMatchServiceTest {
    ...
    void shouldGetAllMatchesByTournamentId() {
        ...
        List<Match> matches = Arrays.asList(
                Match.reconstitute(1L, TOURNAMENT_ID, HOME_TEAM_ID, AWAY_TEAM_ID, null, null, VALID_DATE, "Stadium A", MatchStatus.SCHEDULED, null),
                Match.reconstitute(2L, TOURNAMENT_ID, 3L, 4L, null, null, VALID_DATE.plusDays(1), "Stadium B", MatchStatus.SCHEDULED, null)
        );
    ...
    void shouldGetAllMatchesByTeamId() {
        ...
        List<Match> matches = Arrays.asList(
                Match.reconstitute(1L, TOURNAMENT_ID, HOME_TEAM_ID, AWAY_TEAM_ID, null, null, VALID_DATE, "Stadium A", MatchStatus.SCHEDULED, null),
                Match.reconstitute(2L, TOURNAMENT_ID, HOME_TEAM_ID, 3L, null, null, VALID_DATE.plusDays(1), "Stadium B", MatchStatus.SCHEDULED, null)
        );
