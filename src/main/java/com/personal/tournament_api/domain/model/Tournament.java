package com.personal.tournament_api.domain.model;

import com.personal.tournament_api.domain.enums.StatusTournament;
import com.personal.tournament_api.domain.exceptions.TournamentDomainException;
...
public class Tournament {
    ...
    public void validate() {
        if (isNameInvalid()) {
            throw new TournamentDomainException("Tournament name cannot be null or empty");
        }
        if (isDescriptionInvalid()) {
            throw new TournamentDomainException("Tournament description cannot be null or empty");
        }
    }
    ...
    public void validateIfCanBeDeleted() {
        if (!canBeDeleted()) {
            throw new TournamentDomainException(
                    "Tournament can only be deleted if it is in created, cancelled or completed status"
            );
        }
    }
